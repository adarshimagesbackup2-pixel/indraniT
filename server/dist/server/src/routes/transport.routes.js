...
const transport_schema_1 = require("@bardan/shared/validation/transport.schema");
const validate_1 = require("../middleware/validate");
const auth_1 = require("../middleware/auth");
const errorHandler_1 = require("../middleware/errorHandler");
const transportService = __importStar(require("../services/transport.service"));
...
router.post("/", (0, validate_1.validateBody)(transport_schema_1.transportSchema), (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const transport = await transportService.createTransport(req.body);
    res.status(201).json({ success: true, data: transport });
}));
router.put("/:id", (0, validate_1.validateBody)(transport_schema_1.transportUpdateSchema), (0, errorHandler_1.asyncHandler)(async (req, res) => {
