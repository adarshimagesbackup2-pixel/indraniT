      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <div>
          ...
          <div className="text-lg font-bold">
            <SensitiveAmount value={formatCurrency(data.totalOrdersValue)} />
          </div>
        </div>
        <div>
          <div className="text-xs text-slate-500">Payments Received</div>
          <div className="text-lg font-bold text-success">
            <SensitiveAmount value={formatCurrency(data.totalPayments)} />
          </div>
        </div>
        <div>
          ...
          <div className="text-sm font-semibold">
            <SensitiveAmount
              value={`${formatCurrency(data.paymentsByMode.CASH ?? 0)} / ${formatCurrency(
                data.paymentsByMode.UPI ?? 0,
